...
<div class="container" style="margin-top:25px">
  <div class="row">
          ...
          <div class="row">
              <div class="col-md-6">
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                  <img src="foto/manager/<?php echo $isi['FOTO']; ?>" height="300" widht="300">
                  <b>Uploud Foto</b></br>   
    ...
    <!-- tutup biodata -->
        ...
        <?php include 'component-manager/tamu.php'; ?>
...
if(isset($_POST['ubah_pass'])){
   ...
   if($pas1==$pas2){
      $ubah = "UPDATE user SET PASSWORD ='$new_pass' WHERE USERNAME='$ex' AND LEVEL=2";
...
if($tipe_file == "image/jpeg" || $tipe_file == "image/png"){ // Cek apakah tipe file yang diupload adalah JPG / JPEG / PNG
  ...
  if($ukuran_file <= 10000000){ // Cek apakah ukuran file yang diupload kurang dari sama dengan 1MB
    ...
    if(move_uploaded_file($tmp_file, $path)){ // Cek apakah gambar berhasil diupload atau tidak
      ...
      $query = "UPDATE user SET FOTO = '$nama_file' WHERE LEVEL = 2 AND USERNAME='$ex' ";
