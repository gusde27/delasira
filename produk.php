...
<?php 
  ...
  $data = mysqli_query($koneksi,"SELECT * FROM produk LIMIT $mulai, $halaman");
  $no = 1;
?>
...
?>
    <div class="col-sm-6">
      ...
      <div class="card-body">
            ...
            <b><p class="card-text">
              <button type="button" class="btn btn-outline-success btn-sm"><?php echo $d['JENIS_P']; ?></button>
              <center>
              <img src="foto/produk/<?php echo $d['FOTO_P'];?>" width="100%" height="175px">
              </center>
            </p></b> 
            <center><h5 class="card-text"><b><?php echo $d['NAMA_P']; ?></b></h5></center>          
